...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999995 ? Math.random() < 0.99999999444444444444444444 ? Math.random() < 0.99999999375 ? Math.random() < 0.99999999333333333333333333 ? Math.random() < 0.99999999090909090909090909 ? Math.random() < 0.99999999 ? Math.random() < 0.9999999888888888888888888 ? Math.random() < 0.99999998809523809523809523 ? Math.random() < 0.9999999878048780487804878 ? Math.random() < 0.99999998666666666666666666 ? Math.random() < 0.9999999857142857142857142 ? Math.random() < 0.999999984375 ? Math.random() < 0.9999999818181818181818181 ? Math.random() < 0.99999998 ? Math.random() < 0.999999975 ? Math.random() < 0.9999999714285714285714285 ? Math.random() < 0.99999996875 ? Math.random() < 0.99999996428571428571428571 ? Math.random() < 0.9999999615384615384615384 ? Math.random() < 0.99999996 ? Math.random() < 0.99999995 ? Math.random() < 0.9999999444444444444444444 ? Math.random() < 0.9999999375 ? Math.random() < 0.9999999285714285714285714 ? Math.random() < 0.99999991666666666666666666 ? Math.random() < 0.9999999 ? Math.random() < 0.999999888888888888888888 ? Math.random() < 0.999999875 ? Math.random() < 0.999999857142857142857142 ? Math.random() < 0.9999998333333333333333333 ? Math.random() < 0.9999998 ? Math.random() < 0.99999975 ? Math.random() < 0.999999666666666666666666 ? Math.random() < 0.9999995 ? Math.random() < 0.999999 ? Math.random() < 0.99999875 ? Math.random() < 0.99999862825788751714677 ? Math.random() < 0.999998 ? Math.random() < 0.99999794238683127572016 ? Math.random() < 0.9999975 ? Math.random() < 0.99999588477366255144032 ? Math.random() < 0.999995 ? Math.random() < 0.99999382716049382716049 ? Math.random() < 0.9999876543209876543209 ? Math.random() < 0.9999814814814814814814 ? Math.random() < 0.999975 ? Math.random() < 0.99995 ? Math.random() < 0.9999 ? Math.random() < 0.9998 ? Math.random() < 0.9995 ? Math.random() < 0.999 ? Math.random() < 0.998666666666666666666 ? Math.random() < 0.998 ? Math.random() < 0.996 ? Math.random() < 0.995 ? Math.random() < 0.99 ? Math.random() < 0.98666666666666666666 ? Math.random() < 0.98 ? Math.random() < 0.96 ? Math.random() < 0.8 ? 1 : 2 : 3 : 4 : 5 : 6 : "0" : 7 : 8 : 9 : 10 : "Z7" : 27 : -1 : "27+" : "27-" : 54 : 81 : 162 : "27×" : 243 : "27÷" : 486 : 26 : 729 : -2 : "🚫" : "ZZ" : 34 : 41 : "🐧" : 42 : 51 : 64 : "⧓" : "🐾" : 73 : 74 : "▦" : 76 : 77 : 82 : 83 : "🐦" : "∷" : "🐬" : 84 : "🍄" : 85 : "▬-╺" : 86 : "⛄" : 8282 : 90 : 91 : "✔️" : 93 : 96 : 97 : 99 : "27±";
